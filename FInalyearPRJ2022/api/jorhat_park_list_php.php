<?php
    ...
    $sql_1="SELECT * FROM `parks` WHERE pl_district = ' Sivasagar' OR pl_district=' sivasagar' OR pl_district='SIVASAGAR' ORDER BY 'p_id';";
    ...
    if($park==0){
        echo "<h3 class='d-flex justify-content-center'>No parks found!</h3>";
        exit;
    }
    for($i=0;$i<$park;$i++){
